...
ENTRYPOINT cd usr/local/tomcat/webapps && wget http://192.168.42.120:8081/nexus/service/local/repositories/releases/content/com/gamutgurus/gamutkart/107/gamutkart-108.war
